...
public class TokenProvider implements InitializingBean {
    ...
    /**
     * 로그인 성공 시 생성된 Authentication의 내용을 이용하여 Token 생성
     */
    public String createToken(Authentication authentication) {
        ...
        return Jwts.builder().setSubject(authentication.getName())
                .claim(AUTHORITIES_KEY, authorities).signWith(key, SignatureAlgorithm.HS512).setExpiration(validity).compact();
    }

    /**
     * header에서 받아온 토큰을 가지고 복호화하여 Authentication을 얻어내는 작업
     */
